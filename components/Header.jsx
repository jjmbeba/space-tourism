...
import { setMenuState, setTest } from '../slices/menuSlice'
...
const Header = () => {
  ...
  return (
    <div className='w-full relative px-[24px] pt-[24px] lg:pt-[0px] flex items-center justify-between'>
        ...
        <Image className='md:hidden' onClick={() => dispatch(setMenuState())} src='/shared/icon-hamburger.svg' width={24} height={21} alt='hamburger-menu'/>
